...
const PROMPT_KEYS = ['tanach', 'mishnah', 'shas', 'rambam', 'shulchan', 'iyun', 'bekiut', 'friend_envelope', 'friend_tanach', 'friend_mishnah', 'friend_shas', 'friend_rambam', 'friend_shulchan'];
